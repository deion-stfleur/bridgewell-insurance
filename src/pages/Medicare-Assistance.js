        ...
        <div className="service-container_01">
            <div className="service-content_0">
                ...
                <section className="about-service_0">
                    {/* <h2>About</h2> */}
                    <p>At Bridgewell Insurance Agency, we specialize in helping individuals navigate the complexities of Medicare and Medicaid. Whether you’re new to these programs or need help understanding your current options, our team is here to ensure you have the right coverage.</p>
...
export default MedicareAssistance
